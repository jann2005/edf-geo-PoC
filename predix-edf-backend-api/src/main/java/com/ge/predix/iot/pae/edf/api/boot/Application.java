package com.ge.predix.iot.pae.edf.api.boot;
...
@ComponentScan(basePackages = "com.ge.predix.iot.pae")
@EnableSwagger2
@Controller
public class Application
{
    ...
    @RequestMapping("/api")
    public @ResponseBody
    void api(HttpServletRequest request , HttpServletResponse response ) throws IOException
